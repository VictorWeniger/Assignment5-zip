...
/**
 * Developer guide: Registers lightweight API docs endpoints for quick route discovery.
 */
...
/**
 * Registers a lightweight JSON route catalog as an alternative quick entrypoint to Swagger UI.
 */
public final class ApiDocsController {
    ...
    /**
     * Registers API documentation routes on the supplied Javalin app.
     */
