...
function setNlpRunBusy(isBusy) {
  ...
  button.textContent = isBusy ? "Run NLP for this speech (running...)" : "Run NLP for this speech";
}
...
// [ITER4_EXPERIMENT_START]
// Temporary branch-specific instrumentation for retrospective documentation.
// Reworked in iter5.
// [ITER4_EXPERIMENT_END]
