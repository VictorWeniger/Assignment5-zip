...
/**
 * Developer guide: Builds Mongo query documents for combined speech filters.
 */
...
/**
 * Utility for constructing MongoDB filter documents from speech query parameters.
 */
final class SpeechQueryFilterBuilder {
    ...
    /**
     * Builds a filter document from optional speech filter arguments.
     */
    ...
    /**
     * Parses a comma-separated list into de-duplicated trimmed values.
     */
