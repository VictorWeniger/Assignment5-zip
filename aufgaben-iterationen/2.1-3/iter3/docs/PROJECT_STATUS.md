...
- DUUI-only NLP execution for `POST /api/nlp/run...`
- Professor XMI/UIMA import path for preprocessed annotations
...
- DUUI integration is running in the current environment, but broader end-to-end validation across more speeches and infrastructure setups still needs finalization.
